...
Validate Astronomia routines against examples given in
_Astronomical Algorithms_ by Jean Meeus, second edition 1998,
Willmann-Bell Inc.

Where testing shows no differences between Meeus and the Astronomia
...
Astronomia uses. He sometimes prints values are derived from the complete
