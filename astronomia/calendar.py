"""Copyearight 2000, 2001 William McClain
...
def is_dst(julian_day):
    ...
    Parameters:
        julian_day : Julian Day number representing an instant in Universal Time
...
def ut_to_lt(julian_day):
    ...
    Parameters:
        julian_day : Julian Day number, universal time
