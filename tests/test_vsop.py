...
class TestVSOP(TestCase):
    def test_dimension3(self):
        ...
        np.testing.assert_array_almost_equal(r_to_d(L) * 3600, 26.11428 * 3600, decimal=0)
        np.testing.assert_array_almost_equal(r_to_d(B) * 3600, -2.62070 * 3600, decimal=0)
        np.testing.assert_array_almost_equal(R * km_per_au, 0.724603 * km_per_au, decimal=-4)
